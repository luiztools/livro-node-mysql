...
function loadTable(){
    ...
    $.getJSON(webApiDomain + '/clientes', function(data){
        data.forEach(item =>{
            ...
            tbody.append('<tr>' + linha + '<td><a href="#" class="btn btn-danger" data-id="' + item.id + '">x</a></td></tr>')
        })
    })
}
    ...
    <form action="<%= action %>" method="POST" role="form" class="form-horizontal">
        <div class="form-group">
          <label class="control-label" for="nome">Nome: 
              <input type="text" id="nome" name="nome" value="<%= result.nome %>" class="form-control" />
          </label>
        </div>
        <div class="form-group">
          <label class="control-label" for="idade">Idade:
              <input type="number" id="idade" name="idade" value="<%= result.idade %>" class="form-control" />
          </label>
        </div>
        <div class="form-group">
